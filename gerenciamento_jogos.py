...
Label(left_frame, text="Gols da equipe titular ", font=('Times', 14)).grid(row=1, column=0, pady=10)
Label(left_frame, text="Nome da equipe oponente", font=('Times', 14)).grid(row=2, column=0, pady=10)
Label(left_frame, text="Gols da equipe oponente", font=('Times', 14)).grid(row=3, column=0, pady=10)
Label(left_frame, text="Local", font=('Times', 14)).grid(row=4, column=0, pady=10)
Label(left_frame, text="Data", font=('Times', 14)).grid(row=5, column=0, pady=10)
Label(left_frame, text="Grupo", font=('Times', 14)).grid(row=6, column=0, sticky=W, pady=10)
Label(text="Gerenciamento de grupo", font=('Times', 40)).grid(row=4, column=5, sticky=W, pady=10, padx=700)
...
log_op.grid(row=3, column=1, pady=10, padx=20)
log_lc.grid(row=4, column=1, pady=10, padx=20)
log_dt.grid(row=5, column=1, pady=10, padx=20)
